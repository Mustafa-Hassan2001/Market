<div align="center">
  ...
  <h2 align="center"> Market - The Photographer's Website</h2>

  Market is a fully responsive website for Photographer's enthusiasts, <br />responsive for all devices, built using HTML, CSS, and JavaScript.
...
![Market Desktop Demo](https://github.com/Mustafa-Hassan2001/Market/blob/main/1.png)
...
1. Clone the repo
   ```sh
   git clone https://github.com/mustafa-hassan2001/Market.git
